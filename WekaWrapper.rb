...
class WekaWrapper
	...
	def points_to_arff(all_points)
		...
		tem = %x{java -classpath "/research/weka/weka-3-7-5/weka.jar" weka.filters.unsupervised.attribute.StringToNominal -R first-last -i "Tests/test.arff" -o "Tests/test1.arff"}
		@data_arff = "Tests/test1.arff"
	end

	def run_em
		output = %x{java -classpath "/research/weka/weka-3-7-5/weka.jar" weka.filters.unsupervised.attribute.AddCluster  -i "Tests/test1.arff" -o "Tests/out.arff" -I "First" -W "weka.clusterers.EM" }
		puts output
	end
